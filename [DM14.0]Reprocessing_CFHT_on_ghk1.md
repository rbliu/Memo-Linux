...
And go through the multi-band processing steps for one patch (*Don't forget to add the [corresponding config files](https://github.com/LSSTDESC/ReprocessingTaskForce/tree/master/config)*):
```
